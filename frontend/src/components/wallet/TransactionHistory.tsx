        ...
        <table className="w-full text-sm">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="text-left px-4 py-3 font-medium text-gray-500 text-xs">Hash</th>
              <th className="text-left px-4 py-3 font-medium text-gray-500 text-xs">Ledger</th>
          ...
          <tbody className="divide-y divide-gray-50">
            {isLoading ? (
              ...
              <tr>
                <td colSpan={4} className="px-4 py-6 text-center text-red-500 text-xs">
                  {error}
                </td>
              </tr>
              ...
              transactions.map((tx) => (
                <tr key={tx.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-gray-600 text-xs">{tx.ledger}</td>
